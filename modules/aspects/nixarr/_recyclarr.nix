...
let
  ...
  cf = profile: trash_id: score: {
    trash_ids = [ trash_id ];
    assign_scores_to = [{ name = profile; inherit score; }];
  };
  ...
  radarrAudio = [
    { id = "496f355514737f7d83bf7aa4d24f8169"; score = 500;  } # TrueHD ATMOS
    { id = "2f22d89048b01681dde8afe203bf2e95"; score = 450;  } # DTS X
    { id = "417804f7f2c4308c1f4c5d380d4c4475"; score = 300;  } # ATMOS (undefined)
    { id = "1af239278386be2919e1bcee0bde047e"; score = 300;  } # DDPlus ATMOS
    { id = "3cafb66171b47f226146a0770576870f"; score = 275;  } # TrueHD
    { id = "dcf3ec6938fa32445f590a4da84256cd"; score = 250;  } # DTS-HD MA
    { id = "a570d4a0e56a2874b64e5bfa55202a1b"; score = 225;  } # FLAC
    { id = "e7c2fcae07cbada050a0af3357491d7b"; score = 225;  } # PCM
    { id = "8e109e50e0a0b83a5098b056e13bf6db"; score = 200;  } # DTS-HD HRA
    { id = "185f1dd7264c4562b9022d963ac37424"; score = 175;  } # DDPlus
    { id = "f9f847ac70a0af62ea4a08280b859636"; score = 150;  } # DTS-ES
    { id = "1c1a4c5e823891c75bc50380a6866f73"; score = 125;  } # DTS
    { id = "240770601cc226190c367ef59aba7463"; score = 100;  } # AAC
    { id = "c2998bd0d90ed5621d8df281e839436e"; score = 75;   } # DD
  ];

  # Sonarr audio trash IDs (different IDs, same scores)
  sonarrAudio = [
    { id = "0d7824bb924701997f874e7ff7d4844a"; score = 500;  } # TrueHD ATMOS
    { id = "9d00418ba386a083fbf4d58235fc37ef"; score = 450;  } # DTS X
    { id = "b6fbafa7942952a13e17e2b1152b539a"; score = 300;  } # ATMOS (undefined)
    { id = "4232a509ce60c4e208d13825b7c06264"; score = 300;  } # DDPlus ATMOS
    { id = "1808e4b9cee74e064dfae3f1db99dbfe"; score = 275;  } # TrueHD
    { id = "c429417a57ea8c41d57e6990a8b0033f"; score = 250;  } # DTS-HD MA
    { id = "851bd64e04c9374c51102be3dd9ae4cc"; score = 225;  } # FLAC
    { id = "30f70576671ca933adbdcfc736a69718"; score = 225;  } # PCM
    { id = "cfa5fbd8f02a86fc55d8d223d06a5e1f"; score = 200;  } # DTS-HD HRA
    { id = "63487786a8b01b7f20dd2bc90dd4a477"; score = 175;  } # DDPlus
    { id = "c1a25cd67b5d2e08287c957b1eb903ec"; score = 150;  } # DTS-ES
    { id = "5964f2a8b3be407d083498e4459d05d0"; score = 125;  } # DTS
    { id = "a50b8a0c62274a7c38b09a9619ba9d86"; score = 100;  } # AAC
    { id = "dbe00161b08a25ac6154c55f95e6318d"; score = 75;   } # DD
  ];
  ...
  radarr = {
    ...
    radarranime = {
      ...
      quality_profiles = [{
        ...
        quality_sort = "top";
        qualities = [
          { name = "Remux 1080p"; qualities = [ "Remux-1080p" "Bluray-1080p" ]; }
